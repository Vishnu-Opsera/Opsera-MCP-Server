...
import (
	...
	tools_basic_auth "github.com/input-api/mcp-server/tools/basic_auth"
)
...
func GetAll(cfg *config.APIConfig) []models.Tool {
	return []models.Tool{
		...
		tools_auth.CreateHead_api_base_urlTool(cfg),
		tools_auth.CreateHead_api_keyTool(cfg),
		tools_basic_auth.CreateHead_basic_authTool(cfg),
	}
}
